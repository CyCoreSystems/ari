...
[![Build Status](https://travis-ci.org/Amtelco-Software/ari.png)](https://travis-ci.org/Amtelco-Software/ari) [![go.dev reference](https://img.shields.io/badge/go.dev-reference-007d9c?logo=go&logoColor=white&style=flat-square)](https://pkg.go.dev/github.com/Amtelco-Software/ari/v6) 
...
[Amtelco-Software/ari-proxy](https://github.com/Amtelco-Software/ari-proxy).

Install with: 
```sh 
go get github.com/Amtelco-Software/ari/v6
```
...
### AudioURI [![](https://godoc.org/github.com/Amtelco-Software/ari?status.svg)](http://godoc.org/github.com/Amtelco-Software/ari/ext/audiouri)
...
### Bridgemon [![](https://godoc.org/github.com/Amtelco-Software/ari?status.svg)](http://godoc.org/github.com/Amtelco-Software/ari/ext/bridgemon)
...
### Play [![](https://godoc.org/github.com/Amtelco-Software/ari?status.svg)](http://godoc.org/github.com/Amtelco-Software/ari/ext/play)
...
### Record [![](https://godoc.org/github.com/Amtelco-Software/ari?status.svg)](http://godoc.org/github.com/Amtelco-Software/ari/ext/record)
...
Go documentation is available at https://godoc.org/github.com/Amtelco-Software/ari
