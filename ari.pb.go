...
// I had to edit this to avoid refactoring the rest of the library
// too much. Changes are:
// Id fields are replaced with ID
// the String() methods are implemented in other files, so removing from here.
